...
exports['default'] = sweetAlert = swal = function () {
  ...
  (0, _modulesHandleSwalDom.resetMasukan)();
 ...
 * If something is wrong => call showMasukanError with errorMessage
 */
sweetAlert.showMasukanError = swal.showMasukanError = function (errorMessage) {
  var modal = (0, _modulesHandleSwalDom.getModal)();
 ...
 */
sweetAlert.resetMasukanError = swal.resetMasukanError = function (event) {
 ...
 */
var getMasukan = function getMasukan() {
  var $modal = getModal();
  if ($modal) {
 ...
 */
var resetMasukan = function resetMasukan() {
  var $modal = getModal();
  var $input = getMasukan();
...
var resetMasukanError = function resetMasukanError(event) {
  // If press enter => ignore
  if (event && event.keyCode === 13) {
    return false;
  }
...
exports.getMasukan = getMasukan;
exports.setFocusStyle = setFocusStyle;
exports.openModal = openModal;
exports.resetMasukan = resetMasukan;
exports.resetMasukanError = resetMasukanError;
...
var setParameters = function setParameters(params) {
  ...
  if (params.type && !(0, _utils.isIE8)()) {
    var _ret = (function () {
      ...
      var $input = (0, _handleSwalDom.getMasukan)();
      ...
      switch (params.type) {
        ...
        case 'prompt':
          ...
          setTimeout(function () {
            $input.focus();
            $input.addEventListener('keyup', swal.resetMasukanError);
          }, 400);
          break;
      }
    })();
