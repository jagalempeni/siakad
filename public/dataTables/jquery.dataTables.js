...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterMasukan+'"/>';
	 ...
	 *  @memberof DataTable#oApi
	 */
	function _fnFilterComplete ( oSettings, oMasukan, iForce )
	{
		...
		{
			/* Global filter */
			_fnFilter( oSettings, oMasukan.sSearch, iForce, oMasukan.bRegex, oMasukan.bSmart, oMasukan.bCaseInsensitive );
			fnSaveFilter( oMasukan );
	 ...
	 *  @param {object} oSettings dataTables settings object
	 *  @param {string} sMasukan string to filter on
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		 ...
		 * nor scrolling used
		 */
		if ( ! userMasukans && ! scrollX && ! scrollY &&
	...
	DataTable = function( options )
	{
		 ...
		 *  @param {string} sMasukan String to filter the table on
		 ...
		 *    } );
		 */
		this.fnFilter = function( sMasukan, iColumn, bRegex, bSmart, bShowGlobal, bCaseInsensitive )
		{
			var api = this.api( true );
		
			if ( iColumn === null || iColumn === undefined ) {
				api.search( sMasukan, bRegex, bSmart, bCaseInsensitive );
			}
			else {
				api.column( iColumn ).search( sMasukan, bRegex, bSmart, bCaseInsensitive );
			}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *
			 *  @example
			 *    // Masukan text box will be appended at the end automatically
			 *    $(document).ready( function() {
			 *      $('#example').dataTable( {
			 *        "language": {
