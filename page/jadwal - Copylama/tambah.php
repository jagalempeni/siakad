...
if (isset($_POST['simpan'])) {
    ...
    $jam_m   = $_POST['jam_m'];
    $jam_s   = $_POST['jam_s'];
    $simpan  = $koneksi->query("INSERT INTO tb_jadwal (kode_mk, kode_ruang, nama_hari, jam_mulai, jam_selesai, kode_dosen, kelas)VALUES('$matkul', '$ruang', '$hari', '$jam_m', '$jam_s', '$dosen', '$kelas')");
