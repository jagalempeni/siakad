  ...
  <form method="POST" enctype="multipart/form-data">
    ...
    <table  class="table table-bordered table-condensed" id="dataTables-example">
      <thead>
        ...
        <tr>
      <th class="text-center">Presensi (15%)</th>
          <th class="text-center">Tugas (10%)</th>
          <th class="text-center">Quiz (5%)</th>
    ...
    $presensi   = $data['presensi'];
        ...
        $uts        = $data['uts'];
        $uas        = $data['uas'];
       $jumlah = ($presensi * 0.15) + ($tugas * 0.1) + ($quiz * 0.05) + ($uts * 0.3) + ($uas * 0.4);
if ($jumlah >= 85) {
    $grade = "A";
}
if ($jumlah   <= 84) {
