...
// koneksi
$conn = mysqli_connect("localhost","stapinac_w2l","Admin@1","stapinac_w2l");
...
if( isset($_POST["upload"]) ){
	...
	for( $row = 1; $row <= $highestRow; $row++ ){
		...
		$sql = "INSERT INTO tb_mahasiswa(nim, nama, tempat_lahir, tanggal_lahir, alamat, kode_jurusan, smester, jenis_kelamin, email, telpon) 
			VALUES (
			'".$rowData[0][0]."', 
			'".$rowData[0][1]."', 
			'".$rowData[0][2]."', 
		...
		$sql1 = mysqli_query($conn, "INSERT INTO tb_user(user_id, nama, pass, level) VALUES(
			'".$rowData[0][0]."',
			'".$rowData[0][1]."', 
			'123',
			'mahasiswa')
