...
if( isset($_POST["upload"]) ){
	...
	for( $row = 1; $row <= $highestRow; $row++ ){
		...
		$sql = "INSERT INTO tb_mahasiswa(nim, nama, tempat_lahir, tanggal_lahir, alamat, kode_jurusan, smester, tahun_akad, kode_kuri, jenis_kelamin, email, telpon, foto) 
			VALUES (
			'".$rowData[0][0]."', 
			'".$rowData[0][1]."', 
			'".$rowData[0][2]."', 
		...
		$sql1 = mysqli_query($conn, "INSERT INTO tb_user(user_id, nama, pass, level, foto) VALUES(
			'".$rowData[0][0]."',
			'".$rowData[0][1]."', 
			'123',
			'mahasiswa',
