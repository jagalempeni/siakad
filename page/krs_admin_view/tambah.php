...
<?php 
	...
	$tambah =	$koneksi->query("INSERT INTO tb_mahasiswa (nim, nama, tempat_lahir, tanggal_lahir, alamat, kode_jurusan, kelas, angkatan, smester, jenis_kelamin, email, telpon, foto, status_krs)VALUES('$nim', '$nama', '$tempat', '$tgl', '$alamat', '$jurusan', '$kelas', '$angkatan', '$smester', '$jk', '$email', '$telpon', '$foto', 1)");

		$koneksi->query("INSERT INTO tb_user set id ='$nim', nama='$nama', pass='$pass', level='mahasiswa', foto='$foto'");
