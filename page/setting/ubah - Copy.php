        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control" required name="kategori">
                    ...
                    <option value="Wajib" <?php if( $data['kategori']=='Wajib'){echo "selected"; } ?>>Wajib</option>
                    <option value="Prasyarat" <?php if( $data['kategori']=='Prasyarat'){echo "selected"; } ?>>Prasyarat</option>
                </select>
            </div>     
...
<?php 
	if (isset($_POST['ubah'])) {	
        ...
        $ubah    = $koneksi->query("update tb_matkul set  nama_mk='$nama', kategori='$kategori', sks='$sks', smester='$smester' where kode_mk='$kode'");
