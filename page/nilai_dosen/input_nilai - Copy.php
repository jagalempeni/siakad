...
if (isset($_POST['simpan'])) {
    ...
    $preuts        = $_POST['preuts'];
    $preuas        = $_POST['preuas'];
    $simpan     = $koneksi->query("INSERT INTO tb_nilai (nim, tahun_akad, kode_mk, kode_dosen, smestern, kelas, presensi, tugas, quiz, uts, uas, ket, prepre, pretug, prequi, preuts, preuas) VALUES ('$nim', '$tahun_akad', '$kode_mk', '$kode_dosen', '$smester', '$kelas', '$presensi', '$tugas', '$quiz', '$uts', '$uas', '$ket', '$prepre', '$pretug', '$prequi', '$preuts', '$preuas')");
