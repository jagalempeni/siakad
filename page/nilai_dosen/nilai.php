      ...
      <?php
        ...
        $mk    = $koneksi->query("SELECT * FROM tb_jadwal, tb_dosen, tb_matkul, tb_jurusan, tb_ruang WHERE  
          ...
          <tr>
              ...
              <td>
              	<a href="?page=nilai_d&aksi=lihat_mhs&kode_mk=<?= $data['kode_mk']; ?>&dosen=<?= $data['kode_dosen']; ?>&kelas=<?= $data['kelas']; ?>&krs=<?= $data['kode']; ?>" class=" btn btn-flat btn-sm btn-info" ><i class="fa fa-edit"></i> Nilai Mahasiswa</a>
