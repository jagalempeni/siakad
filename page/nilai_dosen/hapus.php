...
<form role="form" method="POST">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Hapus Nilai</h3>
        </div>
        <div class="box-body">
...
if (isset($_POST['simpan'])) {
    ...
    $simpan     = $koneksi->query("DELETE  tb_nilai SET tugas = '$tugas', presensi = '$presensi', uts = '$uts', uas = '$uas' WHERE nim = '$nim' AND kode_mk = '$kode_mk'");
		if ($simpan) {
			echo "
				<script>
				    setTimeout(function() {
