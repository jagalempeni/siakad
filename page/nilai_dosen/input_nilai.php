       ...
       <div class="box-header with-border">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="kode_dosen"  value="<?php echo $dosen;?>" readonly>
            </div>
			...
			<div class="form-group">
                ...
                <input type="number" class="form-control" name="presensi" placeholder="masukan nilai" autofocus>
            </div> 

            <div class="form-group">
                <label>Tugas :</label>
                <input type="number" class="form-control" name="tugas" placeholder="masukan nilai" autofocus>
            </div>

            <div class="form-group">
                <label>UTS :</label>
                <input type="number" class="form-control" name="uts" placeholder="masukan nilai" autofocus>
            </div>

            <div class="form-group">
                <label>UAS :</label>
                <input type="number" class="form-control" name="uas" placeholder="masukan nilai" autofocus>
            </div>
        </div>
...
if (isset($_POST['simpan'])) {
    ...
    $simpan     = $koneksi->query("INSERT INTO tb_nilai (nim, tahun_akad, kode_mk, kode_dosen, smestern, kelas, presensi, tugas, uts, uas) VALUES ('$nim', '$tahun_akad', '$kode_mk', '$kode_dosen', '$smester', '$kelas', '$presensi', '$tugas', '$uts', '$uas')");
