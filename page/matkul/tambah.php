 	...
 	<div class="box box-primary">
	   ...
	   <div class="box-body">
         <div class="form-group">
             ...
             <input type="text" class="form-control" required name="kode" placeholder="masukan kode matakuliah">
         </div>

         <div class="form-group">
            <label>Nama MataKuliah :</label>
            <input type="text" class="form-control" required name="nama" placeholder="masukan nama matakuliah">
        	</div>

         <div class="form-group">
            <label>SKS :</label>
            <input type="number" class="form-control" required name="sks" placeholder="masukan jumlah sks">
        	</div>
...
<?php 
	if (isset($_POST['simpan'])) {
		...
		$simpan  = $koneksi->query("INSERT INTO tb_matkul (kode_matkul, nama_mk, sks, smester, kode_kuri, kode_jurusan) VALUES ('$kode', '$nama', '$sks', '$smester', '$kuri', '$jurusan')");
		if ($simpan) {
			echo "
				<script>
				    setTimeout(function() {
