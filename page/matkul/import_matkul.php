...
<div class="box box-primary">
	...
	<div class="box-body" style="border-top: 1px solid #f4f4f4;">
		<form method="post" action="" enctype="multipart/form-data">
			...
			<a href="download/format-import-matkul.xlsx" class="btn btn-warning btn-sm btn-flat"><i class="glyphicon glyphicon-download"></i> Download Format Import Matakuliah</a>
		</form>
		<br>
...
if( isset($_POST["upload"]) ){
	...
	for( $row = 2; $row <= $highestRow; $row++ ){
		...
		$sql = "INSERT INTO tb_matkul(kode_matkul, nama_mk, sks, smester, kode_jurusan, kode_kuri) 
			VALUES (
			'".$rowData[0][0]."', 
			'".$rowData[0][1]."', 
			'".$rowData[0][2]."', 
