...
<div class="box box-primary">
  ...
  <div class="box-footer">
    ...
    <?php if ($_SESSION['mahasiswa']) { ?>
    <a href="?page=profile&aksi=ubahprofile&id=<?= $id; ?>" class="btn btn-sm btn-flat btn-primary" style="float: right; margin-right: 10px;">Ubah Profile</a>
	<?php } ?>	

    <?php if ($_SESSION['dosen']) { ?>
    <a href="?page=profile&aksi=ubahprofiled&id=<?= $id; ?>" class="btn btn-sm btn-flat btn-primary" style="float: right; margin-right: 10px;">Ubah Profile</a>
    <?php } ?>  								 
